...
function deployEmergency() {
    appState.markets = [
        { question: "Will Iran strike Israel on March 15?", volume: 11000000, liquidity: 2500000, prices: [0.10, 0.99], slug: "iran-strike-israel-march-15", badge: "HIGH VOL" },
        { question: "Will the Fed decrease interest rates by 50+ bps?", volume: 5000000, liquidity: 4100000, prices: [0.03, 0.99], slug: "fed-rates-decrease-50", badge: "SOON" },
        ...
        { question: "Will Trump say 'Jesus' this week?", volume: 3300000, liquidity: 2100000, prices: [0.99, 0.01], slug: "trump-jesus", badge: "ENDING" }
    ];
    updateGlobalStats();
    renderMain();
}
